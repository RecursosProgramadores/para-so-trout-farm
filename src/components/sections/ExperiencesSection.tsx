          ...
          {experiences.map((exp, index) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                {/* Highlight Badge */}
                {exp.highlight && (
                  <div className="absolute top-4 right-4 bg-primary text-primary-foreground px-3 py-1 rounded-full text-xs font-heading font-bold">
                    ¡Popular!
                  </div>
                )}
              </div>
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <span className="text-sm text-primary font-heading">{exp.subtitle}</span>
                  </div>
                </div>
